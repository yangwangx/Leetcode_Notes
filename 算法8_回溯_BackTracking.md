...
[Brace Expansion](https://leetcode.com/problems/brace-expansion/discuss/312876/Python-backtracking) `{a,b,c}d{e,f}`    
**[Brace Expansion II](https://leetcode.com/problems/brace-expansion-ii/discuss/322002/Python-concise-stack-solution)** `{{a,z},a{b,c},{ab,z}}`    
 
### misc
Optimal Account Balancing `还钱问题`[回溯](https://leetcode.com/problems/optimal-account-balancing/discuss/95363/Easy-backtracking-%2B-greedy-solution-with-explanation-(Python-Accepted))    
